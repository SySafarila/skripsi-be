<div class="d-flex flex-column flex-md-row justify-content-center" style="gap: 0.5rem">
    @can('employees-management-update')
        <a href="{{ route('admin.employees-management.edit', $model->id) }}" class="btn btn-sm btn-secondary">Edit</a>
    @endcan
    @can('employees-management-delete')
